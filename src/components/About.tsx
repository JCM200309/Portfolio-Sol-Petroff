        ...
        >
          ...
          <div className="md:col-span-6 flex flex-col justify-center select-none text-left">
            ...
            >
              ...
              <p>
                Femmora significa la unión de lo <strong>femenino </strong>y el <strong >aura</strong>. Diseño desde la <strong >sensibilidad</strong>, entendiendo cada proyecto como una narrativa visual capaz de conectar con lo <strong>emocional </strong>y lo <strong>humano</strong>.
              </p>
              <p>
                Me interesa el cruce entre lo <strong>tangible</strong> y lo <strong>etéreo</strong>: el cuerpo como lienzo por sobre todas las cosas, y la puesta en escena como lenguaje.
              </p>
              <p>
                Trabajo desde una mirada <strong>femenina</strong> e <strong>intuitiva</strong>, explorando la suavidad, la intensidad y lo simbólico como fuerzas que conviven dentro de una misma identidad visual.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="pt-1">
                <a
                  href="mailto:femmora.st@gmail.com"
